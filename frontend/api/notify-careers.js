        ...
        <div style="font-family:Arial,sans-serif;max-width:620px;margin:0 auto;border:1px solid #e0e0e0;border-radius:10px;overflow:hidden;">
          ...
          <div style="padding:28px 24px;">
            <table style="width:100%;border-collapse:collapse;font-size:15px;">
              <tr style="background:#faf5ff;"><td style="padding:12px 14px;border:1px solid #e0e0e0;font-weight:bold;color:#555;width:38%;">Email</td><td style="padding:12px 14px;border:1px solid #e0e0e0;color:#222;"><a href="mailto:${email}" style="color:#7c3aed;">${email}</a></td></tr>
          ...
          <div style="background:#f5f5f5;padding:14px;text-align:center;color:#aaa;font-size:12px;">Flyintake Careers System — Internal Notification</div>
        </div>
      `,
    });
        ...
        <div style="font-family:Arial,sans-serif;max-width:620px;margin:0 auto;border:1px solid #e0e0e0;border-radius:10px;overflow:hidden;">
          ...
          <div style="padding:28px 24px;">
            ...
            <div style="margin-top:24px;padding:16px 18px;background:#faf5ff;border-left:4px solid #7c3aed;border-radius:6px;">
              <p style="margin:0;color:#4f1d96;font-size:15px;">💼 Can't wait? Send your CV directly to:<br/><strong>office@flyintakegc.com</strong></p>
            </div>
            <p style="margin-top:24px;color:#555;font-size:14px;line-height:1.6;">Best regards,<br/><strong style="color:#7c3aed;">The Flyintake Team</strong></p>
          </div>
          <div style="background:#f5f5f5;padding:14px;text-align:center;color:#aaa;font-size:12px;">© Flyintake Global Consulting — You can unsubscribe by emailing us</div>
        </div>
      `,
    });
