...
export default async function handler(req, res) {
  ...
  try {
    // EMAIL 1 — Notify your team with the contact message
    await transporter.sendMail({
      from: '"Flyintake Contact Form" <office@flyintakegc.com>',
      ...
      html: `
        <div style="font-family:Arial,sans-serif;max-width:620px;margin:0 auto;border:1px solid #e0e0e0;border-radius:10px;overflow:hidden;">
          ...
          <div style="padding:28px 24px;">
            <table style="width:100%;border-collapse:collapse;font-size:15px;">
              <tr style="background:#f0f4ff;">
                <td style="padding:12px 14px;border:1px solid #e0e0e0;font-weight:bold;color:#555;width:38%;">From</td>
                <td style="padding:12px 14px;border:1px solid #e0e0e0;color:#222;">
                  <a href="mailto:${from}" style="color:#2563eb;">${from}</a>
                </td>
              </tr>
              <tr>
                <td style="padding:12px 14px;border:1px solid #e0e0e0;font-weight:bold;color:#555;">Subject</td>
                <td style="padding:12px 14px;border:1px solid #e0e0e0;color:#222;">${subject}</td>
              </tr>
            </table>
          ...
          <div style="background:#f5f5f5;padding:14px;text-align:center;color:#aaa;font-size:12px;">
            Flyintake Contact System — Internal Notification
          </div>
        </div>
      `,
    });

    // EMAIL 2 — Auto-reply to the person who contacted
    await transporter.sendMail({
        ...
        <div style="font-family:Arial,sans-serif;max-width:620px;margin:0 auto;border:1px solid #e0e0e0;border-radius:10px;overflow:hidden;">
          ...
          <div style="padding:28px 24px;">
            <p style="font-size:16px;color:#333;line-height:1.6;">
              Hi there! Thank you for contacting <strong>Flyintake Global Consulting</strong>.
              Our team has received your message and will get back to you within <strong>24 hours</strong>.
            </p>
            <div style="margin-top:20px;padding:18px;background:#f8faff;border:1px solid #e0e0e0;border-radius:8px;">
            ...
            <div style="margin-top:24px;padding:16px 18px;background:#f0fdf4;border-left:4px solid #2c7a3f;border-radius:6px;">
              <p style="margin:0;color:#166534;font-size:15px;">
                💚 Need urgent help? Call us directly:<br/>
                <strong>+44 7741020217</strong> | <strong>+91 9121767948</strong>
              </p>
            </div>
            <p style="margin-top:24px;color:#555;font-size:14px;line-height:1.6;">
              Best regards,<br/>
              <strong style="color:#2563eb;">The Flyintake Team</strong>
            </p>
          </div>
          <div style="background:#f5f5f5;padding:14px;text-align:center;color:#aaa;font-size:12px;">
            © Flyintake Global Consulting — office@flyintakegc.com
          </div>
        </div>
      `,
    });
